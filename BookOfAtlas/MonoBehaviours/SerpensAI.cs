...
namespace BookOfAtlas.MonoBehaviours;

public class SerpensAI : EnemyAI
{
    ...
    public static readonly int CreatureID = 196; //176 prev taken
    ...
    public static List<SerpensAI> activeSerpens = [];
                    ...
                    )
                    {
                        ...
                        TargetServerRpc(
                            ...
                            closestPlayer.transform.position
                                - directionToSerpens.normalized * touchOvershoot
                        );
                    ...
                    )
                    {
                        if (chaseMovementAverage > chaseMovementAverageMinimum)
                        {
                            ...
                            if (
                                ...
                                < Config.SerpensMechanicsReactivationChance.Value
                            )
                            {
                                ReactivateServerRpc();
    ...
    public void ObserveState()
    {
        ...
        switch (currentBehaviourStateIndex)
        {
            ...
            case (int)State.Activating:
                ...
                audioSource.PlayOneShot(AudioClipActivate, Config.SerpensVolumeAdjustment.Value);
            ...
            case (int)State.Chasing:
                ...
                audioSource.volume = Config.SerpensVolumeAdjustment.Value;
                audioSource.Play();
            ...
            case (int)State.Consuming:
                ...
                if (currentBehaviourStateIndex == (int)State.Consuming) // Activate the consume specific effects.
                {
                    ...
                    audioSource.PlayOneShot(AudioClipConsume, Config.SerpensVolumeAdjustment.Value);
                }
                else if (currentBehaviourStateIndex == (int)State.Reactivating)
                {
                    ...
                    audioSource.PlayOneShot(
                        AudioClipReactivate,
                        Config.SerpensVolumeAdjustment.Value
                    );
                }
                else
                {
                    // Play reset audio clip.
                    audioSource.PlayOneShot(AudioClipReset, Config.SerpensVolumeAdjustment.Value);
                }
